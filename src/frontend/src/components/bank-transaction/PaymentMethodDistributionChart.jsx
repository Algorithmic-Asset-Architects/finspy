...
const PaymentMethodDistributionChart = () => {
    ...
    axios.get('/api/bank-trans/')
      .then(response => {
        ...
        rawData.forEach(item => {
          const method = item.payment_type ? item.payment_type : (item.t_type || "Unknown");
  ...
  return (
    ...
    >
      <h2 className="text-lg font-medium mb-4 text-gray-100">Payment Method Distribution</h2>
